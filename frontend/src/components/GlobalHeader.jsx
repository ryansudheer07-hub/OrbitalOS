...
function GlobalHeader() {
  ...
  return (
    <header className="pointer-events-none fixed inset-x-0 top-6 z-50 flex justify-center px-4">
      <nav className="cosmic-nav pointer-events-auto flex items-center gap-2 rounded-full border border-white/10 px-4 py-2 text-white shadow-[0_0_0_1px_rgba(255,255,255,0.05)]">
        <button
          type="button"
